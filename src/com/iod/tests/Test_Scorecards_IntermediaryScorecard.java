...
import com.iod.page_objects.Scorecards_IntermediaryScorecard;
import com.iod.utils.Reports;
import com.iod.utils.Screenshot;

public class Test_Scorecards_IntermediaryScorecard extends Scorecards_IntermediaryScorecard{

	ExtentTest scorecardInterim;
	...
	public void validateReportData(WebElement firmToBeValidated) {		
		...
		ExtentTest validateReport = scorecardInterim.createNode("Validate Report Data for "+firmNameBeforeClick,"Validate the Report Name & Quarter value.");
	...
	public void downloadScorecardExtract() {
		ExtentTest ExportToExcel = scorecardInterim.createNode("Export To Excel.","Validate if User can successfully export Scorecard List.");
	...
	public void validate_intermediaryScorecardPage() {
		scorecardInterim = Reports.extent.createTest("Scorecard - Intermediary Scorecard","Validate Test Scenarios for Intermediary Scorecard page.");
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			e.printStackTrace();
